	...
	function animateSection() {
		...
		sectionsAvailable.each(function(){
			var actualBlock = $(this),
				...
				halhOfHeihtBlock = actualBlock.height() / -1.5;
			if (location.pathname === '/' || location.pathname === '/index.html' || location.pathname === '/index-ru.html') {
				halhOfHeihtBlock = actualBlock.height() / -4;
			}
			//according to animation type and window scroll, define animation parameters
			var animationValues = setSectionAnimation(offset, windowHeight, animationType);
			
			transformSection(actualBlock.children('div'), animationValues[0], animationValues[1], animationValues[2], animationValues[3], animationValues[4]);
			( offset >= halhOfHeihtBlock && offset < windowHeight ) ? actualBlock.addClass('visible') : actualBlock.removeClass('visible');
		});
